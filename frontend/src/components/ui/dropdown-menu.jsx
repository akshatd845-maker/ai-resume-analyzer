  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "text-[rgba(255,255,255,0.80)] outline-none select-none",
        "focus:bg-[rgba(255,255,255,0.07)] focus:text-white",
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-40",
        "data-[inset]:pl-8",
        "data-[variant=destructive]:text-[#EF4444] data-[variant=destructive]:focus:bg-[#EF4444]/10",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        "[&_svg:not([class*='text-'])]:text-[rgba(255,255,255,0.45)]",
        className
      )}
      {...props}
    />
...
function DropdownMenuCheckboxItem({ className, children, checked, ...props }) {
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-lg py-1.5 pr-2 pl-8 text-sm",
        "text-[rgba(255,255,255,0.80)] outline-none select-none",
        "focus:bg-[rgba(255,255,255,0.07)] focus:text-white",
        "data-[disabled]:pointer-events-none data-[disabled]:opacity-40",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
...
function DropdownMenuShortcut({ className, ...props }) {
  return (
    <span
      ...
      className={cn("ml-auto text-xs tracking-widest text-[rgba(255,255,255,0.35)]", className)}
      {...props}
    />
  )
}
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "text-[rgba(255,255,255,0.80)] outline-none select-none",
        "focus:bg-[rgba(255,255,255,0.07)] focus:text-white",
        "data-[state=open]:bg-[rgba(255,255,255,0.07)] data-[state=open]:text-white",
        "data-[inset]:pl-8",
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        "[&_svg:not([class*='text-'])]:text-[rgba(255,255,255,0.45)]",
        className
